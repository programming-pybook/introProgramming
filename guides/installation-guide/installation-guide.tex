...
\item Click the Jupyter notebook your want to open in left side bar in your folder(trust the workspace if a pop-up window appears)(see \Cref{fig:trust-workspace}). 
    \begin{marginfigure}%
