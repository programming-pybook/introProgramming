...
\emph{Always\/} use \textcolor{vu-color}{one empty line before and after} the following cases:
\marginpar{\B Empty~lines}
\begin{itemize}
    \item functions
    \item classes are surrounded by two white lines instead
\end{itemize}
...
\emph{Always\/} add \textcolor{vu-color}{type hints} to functions using ':' or '->'
