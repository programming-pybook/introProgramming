...
% pdflatex -shell-escape -synctex=1 -interaction=nonstopmode  coding-style-guide.tex
...
\usepackage{minted}       % Support styled listings
\usepackage{mdframed}     % Support frames
